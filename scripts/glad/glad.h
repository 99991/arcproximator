...
/* not autogenerated */
/* GLADloadproc returns void* by default */
/* should be function pointer instead so we get less warnings */
typedef int (*glad_func_ptr)();
typedef glad_func_ptr (*GLADloadproc)(const char *name);
